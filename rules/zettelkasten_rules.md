# KI-Regelwerk für Zettelkasten-Verarbeitung

> Systemregeln und Kontextvorgaben für KI-Assistenten, die in diesem Zettelkasten arbeiten. Basiert auf Sönke Ahrens: Das Zettelkasten-Prinzip.
...
- **never_do_more_than_requested:** Tue niemals mehr als verlangt. Halte die Antworten präzise, direkt und beschränke dich strikt auf die angeforderte Aufgabe. Vermeide ungefragte Zusatzarbeiten, abschweifende Erklärungen oder das eigenmächtige Erstellen zusätzlicher Strukturen.


---

# Kapitel 1: Das Problem: Unorganisiertes wissenschaftliches Arbeiten & Willenskraft-Falle

## 📖 Guidelines

### Das Problem
Wissenschaftliches Schreiben und Denken ist allgegenwärtig, wird aber selten systematisch gelernt. Viele Studierende und Forschende versuchen, fehlende Struktur durch Willenskraft und Selbstdisziplin auszugleichen. Willenskraft is jedoch eine begrenzte Ressource, die sich schnell erschöpft. Ohne ein verlässliches System geht das meiste Gelesene und Gedachte verloren, was zu Schreibblockaden, Prokrastination und der Angst vor dem leeren Blatt führt.

### Die Lösung
Der Schlüssel zum Erfolg liegt nicht in mehr Willenskraft, sondern in der intelligenten Gestaltung der eigenen Arbeitsumgebung (Environmental Design) und verlässlichen Routinen. Durch die Auslagerung des Erinnerns an ein verlässliches externes System (den Zettelkasten) wird das Gehirn von organisatorischen Entscheidungen entlasten. Dies setzt mentale Kapazitäten für das eigentliche Denken, Verstehen und Entwickeln von Ideen frei.

## 🤖 KI-Anweisungen (AI Instructions)

- Verlasse dich bei der Wissensstrukturierung nicht auf ad-hoc Lösungen, sondern fördere verlässliche, wiederkehrende Workflows.
- Entlaste das Arbeitsgedächtnis durch klare, atomare Notizen und eindeutige Verknüpfungen.
- Fokussiere dich darauf, den Übergang vom Lesen zum Schreiben fließend und reibungslos zu gestalten.
...
### Das Problem
Passives Lesen (Anstreichen, wiederholtes Lesen) erzeugt die Illusion des Verstehens (Mere-Exposure-Effekt), ohne dass Inhalte langfristig verarbeitet werden. Der Bestätigungsfehler (Confirmation Bias) verleitet dazu, nur thesenstützende Aspekte wahrzunehmen. Wortwörtliche Mitschriften (z. B. am Laptop) umgehen den Verstehensprozess.

### Die Lösung
Schreibendes Lesen. Das Umschreiben und Verdichten des Gelesenen in eigene Worte (Elaboration/deliberate practice) zwingt zum Verständnis und deckt Wissenslücken auf. Lektürenotizen (Kernpunkte mit Seitenangaben) werden in Zotero abgelegt. Der Bestätigungsfehler wird durch gezieltes Aufschreiben von Gegenargumenten und Widersprüchen überwunden. Dateien werden einheitlich alphabetisch nach 'AutorJahr' sortiert.

## 🤖 KI-Anweisungen (AI Instructions)

- Leite den Benutzer an, gelesene Inhalte nicht bloß zu kopieren, sondern in eigenen Worten verdichtet zu reformulieren (keine reinen Protokolle oder Exzerpte).
- Bestehe bei Lektürenotizen auf präzise Belege und Seitenangaben (z. B. 'Auf S. X steht Y').
- Ermutige den Benutzer aktiv dazu, gezielt nach Gegenargumenten oder widersprüchlichen Befunden zu suchen, um den Bestätigungsfehler zu überwinden.
- Schlage für abgelegte Texte und Kopien ein einheitliches Benennungsschema ('AutorJahr') vor.
...
### Das Problem
Unvollständige Mitschriften, bloßes Zitatsammeln und die unkritische Übernahme fremder Fragestellungen verhindern das eigene Hinausdenken über Texte. Das Aufschieben großer Schreibprojekte resultiert oft aus unrealistischen Etappenzielen (z. B. eine Seite pro Tag). Zudem arbeitet das Gehirn beim Erinnern unzuverlässig und konstruiert Gedanken im Nachhinein passend.

### Die Lösung
Regelmäßiges Verfassen von Zetteln (Investorenprinzip). Ein Zettel ist eine eigenständige, in sich geschlossene Einheit, die genau einen Gedanken präzise in eigenen Worten und mit Quellennachweis formuliert (Atomarität). Durch die bewusste gedankliche Verknüpfung (Elaboration) entstehen assoziative Hinweisreize (Cues), die das Wiederauffinden ermöglichen. Flüchtige Notizen werden nach dem Übertragen konsequent entsorgt.

## 🤖 KI-Anweisungen (AI Instructions)

- Leite den Benutzer an, jeden Zettel auf genau einen zentralen Gedanken zu begrenzen (Atomaritätsprinzip).
- Stelle sicher, dass Zettel als in sich geschlossene, dauerhaft verständliche Texte mit vollständigen Sätzen und Quellenbelegen formuliert sind.
- Fordere den Benutzer zur aktiven Elaboration auf, indem du fragst: 'Inwiefern ist das für dich relevant?' oder 'Wie passt das zu deinen bestehenden Gedanken?'.
- Erinnere den Benutzer daran, flüchtige Notizen nach dem Übertragen konsequent zu löschen.
...
### Das Problem
Starre Top-down-Systematiken (Ablagelogik) engen das Denken ein und verhindern das Entstehen neuer Synergien. Zu viele, unüberlegte Schlagworte (Tags) erzeugen unübersichtliches Chaos. Ein reines Hyperlinknetzwerk ohne Stellordnung (Folgezettel) verhindert das Entstehen kohärenter Gedankenstränge.

### Die Lösung
Bottom-up-Strukturierung. Themen wachsen organisch aus dem Verweisnetzwerk heraus. Neue Zettel werden als Folgezettel hinter thematisch verwandten Zetteln einsortiert. Schlagworte werden sparsam vergeben (max. 2-3 Zettel pro Begriff) und basieren auf der Entnahmelogik ('In welchem Kontext möchte ich später darauf stoßen?'). Überblickszettel (Sammelverweise) strukturieren lokale Cluster. Querverweise zwischen Kontexten erzwingen Vergleiche, Differenzierungen (Darwin-Methode) und Korrekturen. Formale Längenbeschränkungen (DIN A6/Bildschirmgröße) sichern Präzision.

## 🤖 KI-Anweisungen (AI Instructions)

- Leite den Benutzer an, Schlagworte sparsam und streng nach der Entnahmelogik (Sicht des zukünftigen Suchens) zu vergeben.
- Schlage gezielt Querverweise zwischen inhaltlich verwandten, aber in unterschiedlichen Gedankenkontexten stehenden Zetteln vor.
- Unterstütze die Erstellung von Überblickszetteln (Sammelverweisen), um wachsende Cluster lokal zu strukturieren, statt eine starre Gesamthierarchie einzuführen.
- Achte strikt darauf, dass Zettel kurz und bündig bleiben (maximal Bildschirmgröße ohne Scrollen, ca. DIN A6).
- Fordere den Benutzer beim Einordnen auf, nach Widersprüchen, Doppelungen oder begrifflichen Differenzen zu suchen.
...
### Das Problem
Themenfindung und Gliederung werden oft als isolierte Phase (z. B. durch Brainstorming) missverstanden. Brainstorming stützt sich jedoch auf leicht zugängliche, emotionale und oft irrelevante Erinnerungen des Gehirns (Availability Bias) und führt zu unpräzisen Themen. Starre Vorgaben und Pläne demotivieren und entziehen das Gefühl der Selbstbestimmung.

### Die Lösung
Bottom-Up-Themenfindung. Man schaut, wo sich im Zettelkasten thematische Cluster gebildet haben. Die Zettel des Projekts werden auf einem virtuellen oder realen Schreibtisch in eine vorläufige argumentative Reihenfolge gebracht, wodurch Lücken sichtbar werden. Der Fokus verengt sich streng auf die Beantwortung einer zentralen Fragestellung für Dritte (Weglassen von Unwichtigem). Flexibilität und autonome Entscheidungen auf Sicht sichern die Motivation und Energie.

## 🤖 KI-Anweisungen (AI Instructions)

- Leite den Benutzer an, Themen und Fragestellungen Bottom-up aus bereits existierenden Zettelclustern zu entwickeln, statt isoliertes Brainstorming zu betreiben.
- Unterstütze den Benutzer dabei, Zettel für ein konkretes Schreibprojekt auf einer separaten Arbeitsfläche (virtueller Schreibtisch) zu sammeln und in eine vorläufige Argumentationskette zu bringen.
- Lenke den Blick des Benutzers gezielt auf das Schließen argumentativer Lücken, die erst durch das lineare Ordnen der Zettel sichtbar werden.
- Ermutige den Benutzer, irrelevantes Material, das nicht zur zentralen Fragestellung des Projekts beiträgt, konsequent auszusortieren (Fokus verengen).
...
### Das Problem
Schreibblockaden entstehen durch den Versuch, den perfekten Text im ersten Wurf zu verfassen. Starre Zeitpläne scheitern regelmäßig an der Overconfidence Bias und der Planning Fallacy (systematisches Unterschätzen von Zeitbedarf trotz gegenteiliger Erfahrung). Zudem dehnt sich Arbeit unproduktiv aus, um die verfügbare Zeit zu füllen (Parkinsonsches Gesetz).

### Die Lösung
Konsequente Trennung von Rohfassung und Überarbeitung. Der erste Entwurf dient nur dem Paraphrasieren der Zettelkette (Hemingway/Žižek-Methode). Gliederungen bleiben flexibel und dienen der Orientierung, nicht der Einengung. Paralleles Arbeiten an mehreren Manuskripten in unterschiedlichen Stadien verhindert Blockaden (Aikido-Prinzip: Bei Widerstand das Thema wechseln). Planung auf Sicht in kurzen, täglich abschließbaren Schritten mindert Prokrastination (Zeigarnik-Effekt). Radikales Kürzen überflüssiger Passagen ('Kill your darlings') wird durch das Auslagern in ein Reste-Dokument erleichtert.

## 🤖 KI-Anweisungen (AI Instructions)

- Rate dem Benutzer dringend davon ab, beim Schreiben der Rohfassung bereits auf Perfektion und stilistische Details zu achten.
- Schlage dem Benutzer vor, an mehreren Entwürfen oder Fragestellungen parallel zu arbeiten, um Schreibblockaden durch das Aikido-Prinzip zu umgehen.
- Leite den Benutzer an, Gliederungen dynamisch anzupassen und als flexible Orientierungshilfen statt als starre Pläne zu betrachten.
- Unterstütze das radikale Überarbeiten und Kürzen ('Kill your darlings'), indem du dem Benutzer empfiehlst, gelöschte Passagen in ein separates Reste-Dokument auszulagern.
- Empfiehl eine 'Planung auf Sicht' in kurzen, an einem Tag abschließbaren Abschnitten, um die Planning Fallacy und das Parkinsonsche Gesetz zu umgehen.
...
### Das Problem
Reine Willenskraft und gute Vorsätze reichen für eine Verhaltensänderung nicht aus; sie verpuffen meist nach einer Woche. Stress und Zeitdruck (Tunneleffekt) führen dazu, dass man reflexartig an alten, ineffizienten Gewohnheiten festhält, selbst wenn man dadurch unter Druck geraten ist.

### Die Lösung
Aufbau fester Gewohnheiten (Stift beim Lesen, gewohnheitsmäßiges Ververzetteln und Verknüpfen) statt reiner Willensanstrengung. Die Einsicht in die extreme Einfachheit des Zettelkasten-Prinzips hilft, den Teufelskreis aus stressbedingter Prokrastination und zeitraubendem Suchen dauerhaft zu durchbrechen. Die Umstellung kann sofort im laufenden Betrieb erfolgen.
